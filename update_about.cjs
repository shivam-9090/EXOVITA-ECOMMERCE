...
const About: React.FC = () => {
  ...
  return (
    <div className="about-page-new">
      ...
      <section className="about-hero">
        <AnimatedSection animation="fade-in">
          <div className="about-hero-content">
            <h1 className="hero-title">The Essence of <span className="text-gold">EXOVITA</span></h1>
      ...
      {/* Ingredients Grid */}
      <section className="about-section ingredients-section-new">
        <div className="container">
          <AnimatedSection animation="fade-up">
            <div className="section-header center">
              <h2 className="section-title">Purest Ingredients</h2>
              <p>No chemicals. No shortcuts. Just nature's best.</p>
            </div>
            
            <div className="ingredients-grid">
              {['Amla', 'Bhringraj', 'Brahmi', 'Neem', 'Hibiscus', 'Aloe Vera'].map((item) => (
                <div className="ingredient-card" key={item}>
                  <div className="card-icon">🌿</div>
                  <h4>{item}</h4>
                </div>
              ))}
              <div className="ingredient-card highlight">
                <div className="card-icon">🥥</div>
                <h4>Pure Coconut Oil Base</h4>
              </div>
            </div>
          </AnimatedSection>
        </div>
...
const filePath = path.join('src', 'pages', 'About.tsx');

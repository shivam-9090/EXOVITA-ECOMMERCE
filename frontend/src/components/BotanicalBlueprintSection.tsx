    ...
    () => [
      {
        name: "Amla",
        img: amlaImg,
        benefits: ["Promotes growth", "Prevents greying"],
      },
      {
        name: "Bhringraj",
        img: bhringrajImg,
        benefits: ["Reduces hair fall", "Strengthens roots"],
      },
      {
        name: "Brahmi",
        img: brahmiImg,
        benefits: ["Nourishes scalp", "Improves texture"],
      },
      {
        name: "Hibiscus",
        img: hibiscusImg,
        benefits: ["Boosts volume", "Prevents dryness"],
      },
      {
        name: "Neem",
        img: neemImg,
        benefits: ["Controls dandruff", "Scalp health"],
      },
      {
        name: "Shikakai",
        img: shikakaiImg,
        benefits: ["Natural cleanser", "Root strength"],
      },
      {
        name: "Coconut Base",
        img: coconutOilImg,
        benefits: ["Deeply moisturizes", "Prevents protein loss"],
      },
    ],
    [],
  );
    ...
    <section className="botanical-section-new">
      ...
      >
        <div className="scrolling-track-new">
          ...
          {[...ingredients, ...ingredients, ...ingredients, ...ingredients].map(
            (item, idx) => (
